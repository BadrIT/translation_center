...
$(document).ready(function() {
  ...
  $('.inplace_key').each(function(){
    ...
    $('#inplace_editing').append($('<a>').attr('title', 'Click to visit key').attr('target', '_blank').attr('href', Routes.translation_center_translation_key_path(id)).attr('data-id', id).attr('style', 'left:' + left + 'px;top:' + top + 'px' ).attr('class', 'icon-edit badge ' + badgeClass  + ' inplace_edit_button'));
